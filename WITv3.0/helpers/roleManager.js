...
function hasPermission(member, requiredPermissions) {
    ...
    const permissionChecks = {
        admin: isAdmin,
        founder: isFounderOrHigher,
        leadership: isLeadershipOrHigher,
        officer: isOfficerOrHigher,
        council: isCouncilOrHigher,
        certified_trainer: isCertifiedTrainerOrHigher,
        training_ct: isTrainingCtOrHigher,
        fleet_commander: isFleetCommanderOrHigher,
        training_fc: isTrainingFcOrHigher,
        assault_line_commander: isAssaultLineCommanderOrHigher,
        line_commander: isLineCommanderOrHigher,
        resident: isResidentOrHigher,
        commander: isCommanderOrHigher,
        auth: canAuth,
        public: () => true,
    };
